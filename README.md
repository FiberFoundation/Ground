...
2. **Clone the project**. `git clone https://github.com/FiberFoundation/Ground`.
...
## Technologies
Fiber Platform offers a rich development experience using the following technologies:
